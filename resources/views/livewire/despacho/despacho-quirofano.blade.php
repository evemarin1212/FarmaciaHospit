            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-1/2 shadow-lg">
                    ...
                    <ul class="space-y-2">
                        @foreach($MedicamentosSeleccionados as $medicamento)
                            <li>
                                ...
                                <strong>Cantidad Solicitada:</strong> {{ $medicamento['cantidad_solicitada'] }} <br>
                                <strong>Cantidad Despachada:</strong> {{ $medicamento['cantidad'] }}
                            </li>
                        @endforeach
                    </ul>
                ...
                @elseif($accion === 'eliminar')
                    ...
                    <p class="mb-4">
                        ...
                        Las cantidades despachadas serán devueltas a los lotes y medicamentos.
                    </p>
