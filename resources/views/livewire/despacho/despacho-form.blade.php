    ...
    <div class="mb-6">
        <div class="py-12 flex justify-center items-center">
            <div class="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg p-6 relative">
                ...
                @if ($formView)
                    <div class="max-w-4xl mx-auto p-4 bg-white dark:bg-gray-800 shadow-md rounded-lg">
                        <form wire:submit.prevent="guardarDespacho">
                            <!-- Tipo de despacho -->
                            <div class="mb-4">
                                <label for="tipo_despacho"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-200">Tipo de
                                    Despacho:
                                </label>
                            ...
                            <div>
                                @if (in_array($tipo_despacho, ['emergencia', 'hospitalizado']))
                                    ...
                                    @if ($paciente_opcion === 'nuevo')
                                        <div class="mb-4">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Datos del
                                                Paciente:
                                            </label>
                                            <div class="mt-2 grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <input type="text" wire:model="paciente_data_dni" placeholder="Cedula"
                                                        class="w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200">
                                    ...
                                    @elseif ($paciente_opcion === 'search')
                                        <div class="mb-4">
                                            <input type="text" wire:model.debounce.300ms="search" id="paciente_search"
                                                placeholder="Buscar por cédula"
                                                class="w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200">

                                            @if ($pacientes->isNotEmpty())
                                                <ul
                                                    class="mt-2 border border-gray-300 rounded-md shadow-sm max-h-48 overflow-y-auto dark:bg-gray-700 dark:text-gray-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex gap-2 mt-1">
                                        <select wire:model.live="medicamento_solicitado_id" id="medicamento_solicitado_id"
                                            class="flex-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200">
                                            <option value="">Seleccione un medicamento</option>
                                            @foreach ($medicamentos as $medicamento)
                                                <option value="{{ $medicamento->id }}">{{ $medicamento->nombre }}</option>
                                            @endforeach
                                        ...
                                        <input type="number" wire:model="cantidad_medicamento_solicitado"
                                            ...
                                            class="w-40 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200">
                                        ...
                                        <button type="button" wire:click="agregarMedicamentoSolicitado"
                                            class="px-4 py-2 bg-blue-500 text-white rounded-md shadow-sm">Agregar</button>
                                    </div>
