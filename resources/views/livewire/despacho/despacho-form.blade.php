                                                ...
                                                @if ($tipo_despacho === 'emergencia')
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea wire:model="observacion" id="observacion" rows="3"
                                                            class="w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200">{{$observacion}}</textarea>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @if (!empty($medicamentos_solicitados_bus) && count($medicamentos_solicitados_bus) > 0)
                                                        <div class="flex space-x-2 mt-2">
                                                            ...
                                                            <input type="number" wire:model="cantidad_medicamento_solicitado" placeholder="Cantidad Solicitada"
                                                                class="w-1/4 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200">
