                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-3/4 shadow-lg overflow-y-auto max-h-3/4">
                        ...
                        <div class="max-h-[75vh] overflow-y-auto">
                            <form wire:submit.prevent="guardarDespacho" class="space-y-6">
                                ...
                                <div>
                                    <label for="tipo_reporte" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                                        Tipo de Reporte
                                    </label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <!-- Fecha Inicio -->
                                    <div>
                                        <label for="fecha_inicio" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                                            Fecha Inicio
                                        </label>
                                    ...
                                    <!-- Fecha Fin -->
                                    <div>
                                        <label for="fecha_fin" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                                            Fecha Fin
                                        </label>
